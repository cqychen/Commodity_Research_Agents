...
- 候选方案：{'model_type': 'ensemble', 'base_models': ['xgboost', 'lightgbm', 'linear'], 'feature_selection': ['inventory_pressure', 'basis_strength', 'profit_cycle', 'hv20_1y_pct'], 'target': 'outright_return_1m', 'validation_strategy': 'rolling_time_series', 'hyperparameter_tuning': 'optuna', 'use_for': ['outright']}
